...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  _quaryUsers(String value) {
    ...
    setState(() {
      ...
      searchedUsers = items.where((user) {
        ...
        print(usertitle);
        print("userrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr");
        print(user["userFirstName"]);
        // print("inside query parammmsssssssssssssssssssssssssssssss");
        // print(usertitle);
        return usertitle;
      }).toList();
    });
  ...
  Future fetch() async {
    var msg = Provider.of<DocMessagesNotifier>(context, listen: false);
                                                      ...
                                                      children: [
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                            height:
                                                                                getSize(50.00),
                                                                            width: getSize(50.00),
                                                                            child: SvgPicture.asset(ImageConstant.imgUseravatarp, fit: BoxFit.fill)),
                                                                        Positioned(
                                                                          // bottom:
                                                                          //     10,
                                                                          // right:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: msgStatus,
                                                                              borderRadius: BorderRadius.circular(getHorizontalSize(80.00)),
                                                                            ),
                                                                          ),
                                                                        )
                                                                      ])),
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                            searchcontoller.text.isNotEmpty
                                                                                ? searchedUsers[index]["userFirstName"] + " " + searchedUsers[index]['userLastName']
                                                                                : item["userFirstName"] + " " + item['userLastName'] ?? "",
                                                                            overflow: TextOverflow.ellipsis,
                                                                            textAlign: TextAlign.left,
                                                                            style: AppStyle.textstylelatomedium14.copyWith(fontSize: getFontSize(16), fontWeight: FontWeight.bold, color: ColorConstant.black900)),
                                                                        Text(
                                                                            searchcontoller.text.isNotEmpty
                                                                                ? searchedUsers[index]["lastMessage"]
                                                                                : item["lastMessage"] ?? "",
                                                                            textAlign: TextAlign.left,
                                                                            style: TextStyle(color: ColorConstant.indigo800, fontSize: getFontSize(16)))
                                                                      ],
                                                                    ),
                                                                  ],
                                                                ),
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                          decoration:
                                                                              BoxDecoration(
                                                                            color: item["numOfUnreadMsgs"].toString() == '0'
                                                        ...
                                                        Align(
                                                            alignment: Alignment
                                                                .centerRight,
                                                            child: Text(
                                                                "${item['lastMessageTime'] == "" ? "" : SimpleDateFormatConverter.timeZoneSet(item['lastMessageTime'])}",
                                                                textAlign:
                                                                    TextAlign
                                                                        .right,
                                                                style: AppStyle
